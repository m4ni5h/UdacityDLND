...
class NeuralNetwork(object):
    ...
    def run(self, features):
        ...
        hidden_inputs = self.activation_function(np.dot(features, self.weights_input_to_hidden)) #None # signals into hidden layer
        hidden_outputs = self.activation_function(hidden_inputs) #None # signals from hidden layer
        
        #  Output layer - Replace these values with the appropriate calculations.
        final_inputs = np.dot(hidden_inputs, self.weights_hidden_to_output) #None # signals into final output layer
        final_outputs = final_inputs #None # signals from final output layer 
